	...
	<section>
		<div class="wrap">
			...
			<form action="${pageContext.request.contextPath}/MemberServlet"
				method="post" name="frm" onsubmit="return loginCheck()">
				...
				<div class="login_fom">
					...
					<p class="login-id">
						<input type="text" name="userid" class="form_input-text"
							placeholder="아이디">
					</p>

					<p class="login-pwd">
						<input type="password" name="pwd" class="form_input-text"
							placeholder="비밀번호">
					</p>
					...
					<p class="login-signup">
						...
						<input type="button" value="회원가입" class="sign-btn"
							onclick="location.href='${pageContext.request.contextPath}/MemberServlet?command=member_write'">
					</p>
				</div>
			</form>
		</div>
