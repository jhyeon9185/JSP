    ...
    <script type="text/javascript">
      ...
      if (window.name == 'update') {
        ...
        window.opener.parent.location.href =
          "${pageContext.request.contextPath}/BoardServlet?command=board_update_form&num=${param.num}";
        ...
        window.opener.parent.location.href =
          "${pageContext.request.contextPath}/BoardServlet?command=board_delete&num=${param.num}";
      }
