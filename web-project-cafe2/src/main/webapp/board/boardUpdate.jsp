<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
   <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/shopping_update.css">
      ...
      <body>
         <div id="wrap" align="center">
            <h1>게시글 수정</h1>
            <form name="frm" method="post" action="${pageContext.request.contextPath}/BoardServlet">
               ...
               <input type="button" value="목록"
                  onclick="location.href='${pageContext.request.contextPath}/BoardServlet?command=board_list'">
            </form>
         </div>
      </body>
