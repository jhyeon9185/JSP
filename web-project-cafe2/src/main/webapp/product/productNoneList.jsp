...
<body>
	...
	<div class="container">
		<h1>
			<a href="${pageContext.request.contextPath}/index.jsp">Cafe Menu</a>
		</h1>

		<div class="menu-grid">
			<c:forEach var="product" items="${productList}">
				<a
					href="${pageContext.request.contextPath}/ProductServlet?command=product_none_detail&num=${product.num}"
					class="menu-card">
