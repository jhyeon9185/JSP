		...
		<body>
			...
			<div class="container">
				...
				<div class="top-actions">
					<a href="${pageContext.request.contextPath}/product/productWrite.jsp" class="btn">신규 메뉴 등록</a>
				</div>

				<div class="menu-grid">
					<c:forEach var="product" items="${productList}">
						<a href="${pageContext.request.contextPath}/ProductServlet?command=product_detail&num=${product.num}"
							class="menu-card">
