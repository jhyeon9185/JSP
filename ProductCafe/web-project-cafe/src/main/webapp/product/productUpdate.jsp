<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="com.controller.dto.ProductVO" %>
        <%@ page import="com.controller.dao.ProductDAO" %>
            <% int num=Integer.parseInt(request.getParameter("num")); ProductVO
                ...
                <body>
                    ...
                    <div class="container">
                        ...
                        <form action="${pageContext.request.contextPath}/ProductServlet?command=product_update"
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>가격</td>
                                    <td><input type="number" name="price" value="<%=product.getPrice()%>" required />
                                    </td>
                                </tr>
                                <tr>
                                    <td>설명</td>
                                ...
                                <tr>
                                    <td>현재 이미지</td>
                                    <td>
                                        <input type="hidden" name="oldPictureurl" value="<%=product.getPictureurl()%>">
                                        <% if(product.getPictureurl() !=null && !product.getPictureurl().isEmpty()) { %>
                                            <img src="${pageContext.request.contextPath}/upload/<%=product.getPictureurl()%>"
                                                width="150" alt="현재 이미지" /><br>
                                            <% } %>
                                                <small style="color: #666;">새 이미지를 선택하면 기존 이미지가 교체됩니다.</small>
                                    </td>
                                </tr>
                                <tr>
                                    <td>새 이미지</td>
